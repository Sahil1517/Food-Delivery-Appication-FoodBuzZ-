  ...
  return (
    ...
    <div className="carousel-inner">
      ...
      <div className="carousel-item">
        <img src="https://source.unsplash.com/random/900x700/?icec" className="d-block w-100" alt="..."/>
      </div>
      <div className="carousel-item">
        <img src="https://source.unsplash.com/random/900x700/?samosa" className="d-block w-100" alt="..."/>
      </div>
    </div>
